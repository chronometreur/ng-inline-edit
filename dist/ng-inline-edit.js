            ...
            function($compile, InlineEditConfig, InlineEditConstants) {
                return {
                    ...
                    link: function(scope, element, attrs) {
                        ...
                        if(attrs.hasOwnProperty("inputValueType") && attrs.inputValueType === "email") {
                        ...
                        } else if(attrs.hasOwnProperty("inputValueType") && attrs.inputValueType === "numeric") {
                            if(attrs.hasOwnProperty("updateIncidence")) {
                                input = angular.element(
                                    (scope.isInputTextarea ?
                                        '<textarea ' : '<input type="text" ') +
                                    'class="ng-inline-edit__input" ' +
                                    ...
                                    'ng-model="inputValue" ' +
                                    'numbers-only ' +
                                    'update-current-incidence="' + attrs.updateIncidence + '"' +
                                    'placeholder="{{placeholder}}" />');
                            } else {
                                input = angular.element(
                                    (scope.isInputTextarea ?
